...
public class Background extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        w = getWidth();
        h = getHeight();
        Color color1 = new Color(101, 52, 143);
        Color color2 = new Color(212, 87, 150);
    	...
    	for (int i = 0; i <= dotCount; i++) {
    		for (int j = i; j <= dotCount; j++) {
    			...
    			g2d.setColor(new Color(212, 87, 150, alpha).brighter());
    		...
    		g2d.setColor(new Color(212, 87, 150, 150).brighter());
